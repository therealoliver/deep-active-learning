...
# parser.add_argument('--n_round', type=int, default=1, help="number of rounds")
# parser.add_argument('--dataset_name', type=str, default="CIFAR10", choices=["MNIST", "FashionMNIST", "SVHN", "CIFAR10"], help="dataset")
